...
$sql = "SELECT * FROM assoonmovie where id = 3";
...
<!doctype html>
<html lang="en">
  <?php while($asssonmovies = mysqli_fetch_assoc($result)) :  ?>
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <title><?=$asssonmovies['name'] ?></title>x
...
<div class="w-100 bg-full" style="background-image: url('<?=$asssonmovies['image2'] ?>');">
    <div class="container" style="padding-top: 9%;">
        <div class="row pb-5">
            <div class="col-md-4">
                <img src="<?=$asssonmovies['image1'] ?>" class="img-fluid" alt="" style="height:410px;">
            </div>
            <div class="col-md-8 text-justify pt-1 pr-5 text-white">
                <h1><strong><?=$asssonmovies['name'] ?></strong></h1>
                <div class="row">
                    <div class="col-md-1.5 text-center pt-4 pr-3">
                        <span class="pr-4 pl-4 pt-2 pb-2 ml-2 text-white filmtxt"><?=$asssonmovies['janr'] ?></span>
                        <span class="pr-3 pl-3 pt-2 pb-2 text-white filmtxt"><?=$asssonmovies['time'] ?></span>
                    </div>
                </div>
                <div class="row pt-5 pr-3">
                    <p><?=$asssonmovies['director'] ?></p>
                </div>
                <div class="row pt-3 pr-3">
                    <p><?=$asssonmovies['productor'] ?></p>
                </div>
                <div class="row pt-3 pr-3">
                    <p><?=$asssonmovies['dateofproduct'] ?></p>
                </div>
                <div class="row pt-3 pr-3">
    ...
    <div class="container  pt-4 pb-4">
        <div class="row text-justify bg-white pr-3 pl-3" style="padding-top: 6%; padding-bottom: 5%; border: 1px solid #eee; border-radius: 0.5vh;">
            ...
            <div class="col-md-4">
                ...
                <img id="myImg1" src="<?=$asssonmovies['image3'] ?>" class="myImg img-fluid pb-3" alt="" style="height: 250px;">
                <img id="myImg2" src="<?=$asssonmovies['image4'] ?>" class="myImg img-fluid pb-3" alt="" style="height: 250px;">
                <img id="myImg3" src="<?=$asssonmovies['image5'] ?>" class="myImg img-fluid pb-3" alt="" style="height: 250px;">
            </div>
        </div>
        <div  id="kharid" class="row text-justify bg-white pr-3 pl-3 mt-3 " style="padding-top: 4%; padding-bottom: 5%; border: 1px solid #eee; border-radius: 0.5vh;">
