    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top w-100" style="background-color: #dadada">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse w-100" id="navbarSupportedContent">
                ...
                <form>
                    <input type="text" name="search" placeholder="جستجو" onfocus="this.placeholder='جستجو فیلم، تئاتر و سینما'" onblur="this.placeholder='جستجو'" class="search">
                </form>
                    ...
                    <div class="row pt-5 pb-3">
                        <div class="col-md">
                            <h6><i class="fas fa-icons1 fa-search"></i>
                                ...
                                <span class="pr-4 pl-4 pt-2 pb-2 mr-3 text-white filmtxt" style="background-color: rgba(31,70,113,0.85);">
                                    <?=$_GET['search'] ?></span>
                            </h6>
                        </div>
                    </div>
