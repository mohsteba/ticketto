        ...
        <div class="bg-white pr-3 pl-3"
            ...
            <div class="row text-justify">
                <div class="col-md-3 pr-4">
                    <img src="imgs/sarv.jpg" class="img-fluid rounded img-thumbnail" style="height: 300px;">
                </div>
                <div class="col-md-5 ">
                    <div class="pt-3 pr-0">
                        <h5><strong>
            ...
            <div class="row text-justify pt-4 pr-2">
                <div class="col-md ">
                    ...
                    <div class="pt-2 pl-2">
                        <div class="tab">
                            <button class="tablinks" onclick="openCity(event, 'userTicket')" id="defaultOpen">
                                ورود اعضا
                            </button>
                        ...
                        <div id="userTicket" class="tabcontent pt-5 pb-5">
                            <h6><i class="fas fa-user fa-icons5"></i>
                                اطلاعات کاربری خود را وارد کنید
                            </h6>
                            <form>
                                <div class="form-group pb-2 pt-4" style="padding-left: 60%;">
                                    <input type="text" class="form-control pr-3 pb-3 pt-3" placeholder="ایمیل"
                                           name="email">
                                </div>
                                <div class="form-group pb-2" style="padding-left: 60%;">
                                    <input type="password" class="form-control pr-3 pb-3 pt-3" placeholder="رمز عبور"
                                           name="password">
                                </div>
                                <div class="pb-3 form-inline" style="padding-left: 20%; font-size: 15px;">
                                    <select class="pl-4 custom-select" style="margin-left: 25.1%;">
                        ...
                        <div id="guestTicket" class="tabcontent pt-5 pb-5">
                            <h6><i class="fas fa-user-plus fa-icons5 pb-5 pt-3 pr-2"></i>
                                <span class="pr-4 pl-4 pt-3 pb-3 mr-1 rounded"
                                      style="background-color: #f2dede; border-color: #ebcccc; color: #a94442; font-size: 14px;">
                            کاربر گرامی برای خرید بلیت باید عضو تیکتو باشید.
                            </span>
                            </h6>
                            <a class="btn blue-btn text-white first-item pt-2 pb-2 pr-4 pl-4"
                               href="ozviat.php" style="margin-right: 15%;"
                               role="button">عضویت</a>
                        </div>
