                    ...
                    <div class="col-md-6 pr-4">
                        <form class="row" id="fh5co_contact_form">
                            <div class="col-12 pb-3">
                                <input type="text" class="form-control fh5co_contact_text_box" placeholder="نام و نام خانوادگی" />
                            </div>
                            <div class="col-6 py-3">
                                <input type="text" class="form-control fh5co_contact_text_box" placeholder="ایمیل " />
                            </div>
                            <div class="col-6 py-3">
                                <input type="text" class="form-control fh5co_contact_text_box" placeholder="شماره تماس" />
                            </div>
                            <div class="col-12 py-3">
                                <textarea class="form-control fh5co_contacts_message" placeholder="پیام شما"></textarea>
                            </div>
                            <div class="col-12 py-3 text-center"> <a href="#" class="btn contact-button rounded text-white pr-4 pl-4 pt-2 pb-2">ارسال پیام</a> </div>
                        </form>
                    </div>
