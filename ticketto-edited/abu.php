...
$sql = "SELECT * FROM movies where nameid = 11";
    ...
    <div class="container  pt-4 pb-4">
        <div class="row text-justify bg-white pr-3 pl-3" style="padding-top: 6%; padding-bottom: 5%; border: 1px solid #eee; border-radius: 0.5vh;">
            ...
            <div class="col-md-4">
                ...
                <img id="myImg2" src="<?=$movie['image4'] ?>" class="w-100 myImg img-fluid pb-3" alt="" style="height: 250px;">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                            ...
                            <div class="card-body pt-4 pb-5 pr-5">
                                ...
                                <hr>
                                <div class="row text-justify pr-5 pb-1">
                                    <p><i class="far fa-calendar-alt fa-icons1 pl-1 pr-2 pt-3"></i>
