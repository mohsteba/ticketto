...
$sql = "SELECT * FROM movies where nameid = 3";
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse w-100" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active mr-2 ml-2 ">
                    <a class="nav-link" href="#" data-toggle="modal" data-target="#myModal1"><span class="blue-txt">جدول فروش </span></a>
                </li>
                <li class="nav-item active mr-2 ml-2 ">
...
<div class="w-100 bg-full" style="background-image: url('<?=$movie['image2'] ?>');">
    <div class="container" style="padding-top: 9%;">
        <div class="row pb-5">
            <div class="col-md-4">
                <img src="<?=$movie['image1'] ?>" class="img-fluid" alt="" style="height:410px;">
            </div>
            <div class="col-md-8 text-justify pt-1 pr-5 text-white">
                ...
                <div class="row">
                    <div class="col-md-1.5 text-center pt-4 pr-3">
                        <span class="pr-4 pl-4 pt-2 pb-2 ml-2 text-white filmtxt"><?=$movie['janr'] ?></span>
                        <span class="pr-3 pl-3 pt-2 pb-2 text-white filmtxt"><?=$movie['time'] ?></span>
                    </div>
                </div>
    ...
    <div class="container  pt-4 pb-4">
        <div class="row text-justify bg-white pr-3 pl-3" style="padding-top: 6%; padding-bottom: 5%; border: 1px solid #eee; border-radius: 0.5vh;">
            ...
            <div class="col-md-4">
                ...
                <img id="myImg1" src="<?=$movie['image3'] ?>" class="myImg img-fluid pb-3" alt="" style="height: 250px;">
                <img id="myImg2" src="<?=$movie['image4'] ?>" class="myImg img-fluid pb-3" alt="" style="height: 250px;">
                <img id="myImg3" src="<?=$movie['image5'] ?>" class="myImg img-fluid pb-3" alt="" style="height: 250px;">
            </div>
        </div>
