...
$sql = "SELECT * FROM teatr where teatrid = 1";
...
<div class="w-100 bg-full" style="background-image: url('<?=$teatr['image2']; ?>');">
    <div class="container" style="padding-top: 9%;">
        <div class="row pb-5">
            <div class="col-md-4">
                <img src="<?=$teatr['image1']; ?>" class="img-fluid" alt="" style="height:410px;">
            </div>
            <div class="col-md-8 text-justify pt-4 pr-5 text-white">
                <h1><strong><?=$teatr['name']; ?></strong></h1>
                <div class="row">
