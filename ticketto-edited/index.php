...
<head>
    ...
    <title>تیکتو سامانه ی فروش آنلاین بلیط سینما و تئاتر</title>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inne ">
            <div class="carousel-item active">
                <a href="gorg.php"><img class="d-block w-100" src="imgs/gorgbazi.jpg" alt="First slide"></a>
            </div>
            <div class="carousel-item">
                <a href="jade.php"><img class="d-block w-100" src="imgs/ghadim.jpg" alt="Second slide"></a>
            </div>
            <div class="carousel-item">
                ...
                <?php while($movie = mysqli_fetch_assoc($result)) :  ?>
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card pb-1 ">
                            ...
                            <a href="<?=$movie['htmlfilename']; ?>"><img class="card-img-top img-effect" src="<?=$movie['image1'];?>"
