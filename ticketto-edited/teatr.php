    ...
    <div class="container">
        <div class="row text-justify" style="padding-top: 6%; padding-bottom: 8%;">
            <div class="col-md">
                <div class="row pt-5">
                    <div class="col-md">
                        <h6><i class="fas fa-icons1 fa-theater-masks pl-2"></i>
                            <strong>تئاترهای در حال اجرا:</strong>
                        </h6>
                    </div>
                </div>
                <div class="row pt-4 pb-3">
                     <?php while($teatr = mysqli_fetch_assoc($result)) :  ?>
                    <div class="col-md-3 mb-4">
                        <div class="card pb-1 ">
                            <a href="<?=$teatr['htmlfilename'];?>"><img class="card-img-top img-effect" src="<?=$teatr['image1'];?>" alt="Card image cap"></a>
                            <a class="card-link" href="<?=$teatr['htmlfilename'];?>">
                                ...
                                <div class="pr-2 pl-2">
                                    <a class="btn blue-btn float-left text-white first-item pt-2 pb-2 pr-4 pl-4 mb-2 ml-2"
                                       href="<?=$teatr['htmlfilename'];?>" style="font-size: 12px; "
