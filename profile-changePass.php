        ...
        <div class="row text-justify justify-content-center"
            ...
            <div class="col-md-3 text-justify ml-2 p-2 pb-5 rounded"
                ...
                <a href="profile-changePass.php" style="text-decoration: none;">
                    <h6 class="pr-4 pt-3 txthover" style="color: rgb(49,139,175);"><i class="fas fa-icons5 fa-key pl-2" style="color: rgb(49,139,175);"></i>
...
-->
            ...
            <div class="col-md-8 text-justify rounded pb-3"
                ...
                <div class="pb-2">
                    <p class="pt-4 ">
                        <i class="fas fa-icons3 fa-key pl-1"></i>
                        <strong>تغییر رمز عبور
                        </strong>
                    </p>
                </div>
