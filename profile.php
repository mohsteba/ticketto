                ...
                <div style="padding-left: 20%; padding-right: 20%;">
                    ...
                    <form class="needs-validation" name="myForm" onsubmit="return validateForm();" novalidate>
                        <div class="pt-2 pb-4">
                            ...
                            <input type="text" class="form-control" id="name" placeholder=" نام کاربر" required>
                        ...
                        <div class="pb-4">
                            ...
                            <input type="text" class="form-control" id="lastname" placeholder="نام خانوادگی کاربر"
                                   required>
