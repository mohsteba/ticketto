                ...
                <div class="row pt-4 pr-3 pl-3">
                    <div class="col-3">
                        <div class="contactcard">
                            <img src="imgs/sheyda.png" class="members" alt="John" style="width:100%; height: 190px; border-radius: 100%;">
                            <h6 class="pt-3">شیدا اسحاقی</h6>
                            <p class="title pt-2">طراح و توسعه دهنده وب</p>
                            <p style="font-size: 15px;">دانشگاه صنعتی خواجه نصیر</p>
                            <div class="pt-2 pb-2">
                                <a href="https://twitter.com/login?lang=en"><i class="fa fa-twitter contact-icon pl-1"></i></a>
                                <a href="https://www.linkedin.com/in/kosarfeyzi/"><i class="fa fa-linkedin contact-icon pl-1"></i></a>
                                <a href="https://www.facebook.com/"><i class="fa fa-facebook contact-icon pl-1"></i></a>
                                <a href="mailto:feyzi.kosar@gmail.com"><i class="fa fa-envelope contact-icon"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="contactcard">
                            <img src="imgs/kosarr.jpg" class="members" alt="John" style="width:100%; height: 190px; border-radius: 100%;">
                    ...
                    <div class="col-3">
                        <div class="contactcard">
                            <img src="imgs/hero.jpg" class="members" alt="John" style="width:100%; height: 190px; border-radius: 100%;">
                    ...
                    <div class="col-3">
                        <div class="contactcard">
                            <img src="imgs/moazen.jpg" class="members" alt="John" style="width:100%; height: 190px; border-radius: 100%;">
