...
<div class="w-100 bg-full2" style="background-image: url('imgs/melat1.png');">
    <div class="container" style="padding-top: 9%;">
        <div class="row pb-5">
            <div class="col-md-4">
                <img src="imgs/mellat.gif" class="img-fluid rounded" alt="" style="height:410px;">
            </div>
            <div class="col-md-8 text-justify pt-3 pr-5 text-white">
                <h1><strong>پردیس سینمایی ملت</strong></h1>
                <div class="row pt-5 pr-3">
                    <p>تهران، بزرگراه نیایش، روبروی بزرگراه کردستان</p>
                </div>
                <div class="row pt-2 pr-3 text-danger">
                    <p><i class="fas fa-phone fa-icons4 "></i>
                        <a href="tel:989126977637+" style="text-decoration: none;" class="text-danger">
                            <strong>989126977637+</strong></a></p>
                </div>
            ...
            <div class="col-md-4">
                <div style="padding-left:18%; line-height: 30px;">
                    ...
                    <a class="btn text-dark pt-2 pb-2 pr-2 pl-3 mt-3 mb-5" style="border-color: #6d34ac;"
                       href="#"><i class="fa fa-instagram fa-icons1 pl-2" style="color: #6d34ac;"></i>اینستاگرام</a>
                    <a class="btn text-dark pt-2 pb-2 pr-2 pl-3 mt-3 mb-5 mr-2" style="border-color: #0879a0;"
                       href="#"><i class="fa fa-telegram fa-icons1 pl-2" style="color: #0879a0;"></i>تلگرام</a>
                    <br>
                    <h6><i class="fas fa-history fa-icons1 pl-2"></i>
                        <strong>تاریخچه:</strong>
                    </h6>
                    <p>این پردیس سینما گالری متعلق به شهرداری تهران بوده و دارای ۵ سالن و همچنین گالری و چند رستوران ، کافی شاپ و پارکینگ میباشد.</p>
                
                    <h6><i class="fas fa-map-marker-alt fa-icons1 pl-2 pt-3"></i>
                        <strong>دسترسی به سینما:</strong>
                    </h6>
                    <p>پارک ملت - خیابان ولیعصر - خیابان دستگردی</p>
                    
                <div>
                        <iframe height="200" frameborder="0" style="border:0" allowfullscreen
                                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12954.246698503848!2d51.4414593!3d35.7369971!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3f8e065db5785fa5%3A0xb21da76cb8e110ef!2sMellat+Cineplex!5e0!3m2!1sen!2s!4v1545652470485">
                        </iframe>
                    </div>
                </div>
            </div>
